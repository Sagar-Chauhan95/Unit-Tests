...
import { sumTo, factorial, fibonacci, outputList, outputListLoop, reverseList, reverseListLoop, sumTreeValues, TreeNode, binaryTreeType } from "../src/recursion.js";
...
describe("binary tree recursion", function () {
    const tn3:binaryTreeType = { value: 3, left: null, right: null };
    const tn5:binaryTreeType = { value: 5, left: null, right: null };
    const tn4 :binaryTreeType= { value: 4, left: null, right: null };
    const tn2:binaryTreeType = { value: 2, left: tn4, right: tn5 };
    const binaryTree:binaryTreeType = { value: 1, left: tn2, right: tn3 };
